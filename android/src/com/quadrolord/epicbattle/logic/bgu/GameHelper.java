...
package com.quadrolord.epicbattle.logic.bgu;
...
public class GameHelper implements GoogleApiClient.ConnectionCallbacks,
    ...
    public final static int CLIENT_SIGN_IN = 0x10;
    ...
    public GoogleApiClient.Builder createApiClientBuilder() {
        ...
        if (0 != (mRequestedClients & CLIENT_SIGN_IN)) {
            // Configure sign-in to request the user's ID, email address, and basic
            // profile. ID and basic profile are included in DEFAULT_SIGN_IN.
            GoogleSignInOptions gso = new GoogleSignInOptions.Builder(GoogleSignInOptions.DEFAULT_SIGN_IN)
                    // client_id from web app!
                    .requestIdToken("192398468963-634fvhn5nrih5bor65rmh4tnkkgsb9v1.apps.googleusercontent.com")
//                    .requestProfile()
                    .requestEmail()
                    .build();
    ...
    public void beginUserInitiatedSignInNew() {
